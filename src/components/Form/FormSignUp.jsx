	...
	return (
		<>
			<form onSubmit={handleSubmit} className='auth-form'>
				...
				<div className='auth-form__field'>
					{errors.test && (
						<span className='auth-form__error'>{errors.test}</span>
					)}
					<input
						value={values.test}
						onChange={handleChange}
						...
						type='text'
						name='test'
						placeholder='Type your test'
					/>
					<label className='auth-form__label' htmlFor='user-test'>
						Test
					</label>
				</div>
				...
				<div className='auth-form__field'>
					...
					<input
						value={values.user?.passwordRepeat}
						onChange={handleChange}
						className='auth-form__input'
					...
					/>
					<label className='auth-form__label' htmlFor='user-password-repeat'>
						Repeat password
					</label>
				</div>
